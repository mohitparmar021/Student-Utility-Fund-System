...
<%@include file="view/admin-navbar.jsp"%>
		...
		<div id="content-wrapper" class="bg-white">
			...
			<div class="container-fluid">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Grant Application</li>
				</ol>
	...
	<form action="updateStatus" method="post">
         ...
         ResultSet rs=objGrant.viewGrantApplicationRecord(id);      
         while(rs.next())
         {
%>
			...
			<div>
			     <input type="text" name="remark" value="<%=rs.getString(12) %>" class="form-control mt-4 field"><span
					class="text-sm ml-4 text-danger">**Status**</span>
			     <input type="text" name="remark" value="<%=rs.getString(13)%>" class="form-control mt-4 field"> <span
					class="text-sm ml-4 mb-4 text-danger">**Remark**</span>
			</div>
