		...
		<div id="content-wrapper" class="bg-white">
			...
			<div class="container-fluid">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Search Applicants</li>
				</ol>

				<div class="card">
					<div class="container-fluid">
						<h4 class="mt-3">Search Applicant</h4>
						<br>
						 <form action="searchApplicant" method="post">
						       <input type="email" name="searchapplicant" required placeholder="Enter Email Address to Search Applicant" class="field form-control mb-3">
						       <input type="submit" value="Search Applicant" class="btn btn-lg btn-success mb-5">
						 </form>
