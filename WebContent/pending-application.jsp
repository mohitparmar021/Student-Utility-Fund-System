	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="bg-white">
			...
			<div class="container-fluid">
				...
				<div class="card">
					<div class="container-fluid">
						<h4 class="mt-3">Pending Application</h4>
						<br>
						...
						<table class="table-responsive-lg table-striped mb-3"
							...
							<tbody>
								<%
									...
									ResultSet rs = (ResultSet) obj2.viewPendingApplication();
									while(rs.next()){
								%>
								<tr>
									<td><%=rs.getInt(1) %></td>
									...
									<td class="text-center"><a href="view-pending-record.jsp?ref_id=<%=rs.getInt(1) %>"
