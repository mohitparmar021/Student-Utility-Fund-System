	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="bg-white">
			...
			<div class="container-fluid">
				...
				<div class="card">
					<div class="container-fluid">
						<h4 class="mt-3">Rejected Application</h4>
						<br>
						...
						<table class="table-responsive-lg table-striped mb-3"
							...
							<tbody>
								<%
									DaoClass obj4 = new DaoClass();
									ResultSet rs = (ResultSet) obj4.viewCancelApplication();
									while(rs.next()){
								%>
								<tr>
									<td><%=rs.getInt(1) %></td>
									...
									<td class="text-center"><a href="view-cancel-record.jsp?ref_id=<%=rs.getInt(1) %>"
