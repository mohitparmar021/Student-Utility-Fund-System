...
<title>Cancel Grants Details</title>
...
<div class="container mt-5 mb-5">
		...
		<div class="">
			<h1 class="text-center">Cancel Grants Details</h1>
			...
			<table class="table-responsive-lg table-striped mb-3 mt-4"
							...
							<tbody>
								<%
								     ...
								     ResultSet rs=(ResultSet)obj.viewCancelGrant(email);
								     while(rs.next())
								     {
								%>
								<tr>
									...
									<td> <span class="confirm"><%=rs.getString(7)%></span></td>
